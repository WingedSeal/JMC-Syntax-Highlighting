...
{
    internal class JMCSyntaxNode(SyntaxNodeType nodeType = SyntaxNodeType.UNKNOWN, string key = "", IEnumerable<JMCSyntaxNode>? previous = null, IEnumerable<JMCSyntaxNode>? next = null, Range? range = null)
    {
