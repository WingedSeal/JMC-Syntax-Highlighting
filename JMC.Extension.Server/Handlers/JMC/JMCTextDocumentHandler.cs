...
{
    internal class JMCTextDocumentHandler : TextDocumentSyncHandlerBase
    {
        private readonly ILogger<JMCTextDocumentHandler> _logger;
        ...
        public JMCTextDocumentHandler(ILogger<JMCTextDocumentHandler> logger)
        {
            _logger = logger;
        }
        ...
        public override async Task<Unit> Handle(DidChangeTextDocumentParams request, CancellationToken cancellationToken)
        {
            foreach (var change in request.ContentChanges)
            {
                ...
                _logger.LogInformation($"Time elapsed for tokenizing jmc: {stopwatch.ElapsedMilliseconds}");
